...
<div
  class="flex cursor-pointer items-center gap-3 rounded-lg px-2 py-1.5 transition-colors hover:bg-neutral-100"
...
>
  ...
  <div class="min-w-0 flex-1">
    <p class="truncate text-xs font-medium text-neutral-800">{displayTitle()}</p>
