...
<div class="miners-page">
  <div class="mx-auto max-w-5xl px-6">
    ...
    <div class="sticky-top sticky top-0 z-20 pb-4 pt-8">
      <h1 class="page-title">Miners</h1>
    </div>

    <!-- Top Miners cards -->
    <TopMiners miners={data.leaderboard} onminerclick={(entry) => goto(`/miners/detail/${entry.userId}`)} />

    <!-- Leaderboard -->
    <div class="leaderboard-section">
      <h2 class="section-title">Leaderboard</h2>
      <p class="section-subtitle">{data.leaderboard.length} explorers</p>
